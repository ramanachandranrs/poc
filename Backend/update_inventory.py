new_content = '''from fastapi import APIRouter, Depends, Query
...
with open(r"c:\Users\RamanachandranRS\Professional\New folder\poc\Backend\routers\inventory.py", "w", encoding="utf-8") as f:
    f.write(new_content)
